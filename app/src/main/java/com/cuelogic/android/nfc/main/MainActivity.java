...
import com.cuelogic.android.nfc.webview.TestBLWebScreenActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void navigate() {
        ...
        Intent intent = new Intent(MainActivity.this, SendInputScreenActivity.class); //SendInputScreenActivity
